...
st.caption('Разработчик: Зайцев Сергей Владиславович')
st.write('Загрузите файл, далее выберите язык и нажмите "Преобразовать". Чтобы сбросить прогресс, перезагрузите страницу.')
st.write('Конвертировать файл в .wav можно по ссылке (не рекомендуется выбирать наивысшее качество): https://online-audio-converter.com/ru/')
